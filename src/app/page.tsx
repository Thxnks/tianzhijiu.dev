    ...
    <>
      ...
      <section id="projects" className="scroll-mt-24 py-24">
        <div className="mx-auto max-w-5xl px-6">
          <p className="text-left text-xs font-medium uppercase tracking-wider md:text-sm text-muted-foreground">Projects</p>
          <h2 className="mt-3 text-left font-serif text-2xl font-medium md:text-3xl">Selected Work</h2>
          <div className="mt-8 divide-y divide-zinc-200/80 border-y border-zinc-200/80">
            {projectItems.map((project) => (
              <article
                key={project.title}
                className="grid gap-4 py-5 transition-all duration-300 hover:-translate-y-0.5 md:grid-cols-[1fr_20rem] md:items-center md:gap-6">
                <div>
                ...
                <div className="space-y-3 md:text-right">
                  ...
                  <div className="flex md:justify-end">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex h-8 items-center justify-center rounded-full border border-zinc-200/80 bg-white/70 px-3.5 font-serif text-xs font-medium text-foreground shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md">
                      GitHub
                    </a>
                  </div>
                </div>
      ...
      <section id="journey" className="scroll-mt-24 pt-24 pb-14">
        <div className="mx-auto max-w-5xl px-6">
          <p className="text-left text-xs font-medium uppercase tracking-wider md:text-sm text-muted-foreground">Learning Journey</p>
          <h2 className="mt-3 text-left font-serif text-2xl font-medium md:text-3xl">From Java Web to AI Tools</h2>
      ...
      <section id="contact" className="scroll-mt-24 pt-14 pb-24">
        <div className="mx-auto max-w-5xl px-6">
          <p className="text-left text-xs font-medium uppercase tracking-wider md:text-sm text-muted-foreground">Contact</p>
          <h2 className="mt-3 text-left font-serif text-2xl font-medium md:text-3xl">Let's Connect</h2>
